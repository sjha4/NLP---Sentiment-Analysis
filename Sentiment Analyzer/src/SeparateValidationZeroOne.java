...
public class SeparateValidationZeroOne {
	...
	public static void main(String[] args) {
		...
		Path path = Paths.get("C:\\Users\\samir\\Desktop\\2nd Semester\\AI\\HW5\\Dataset\\Validation.txt");
		try (BufferedReader reader = Files.newBufferedReader(path)) {
		    ...
		    while ((line = reader.readLine()) != null) {
		    	...
		    	while (matcher.find()) {
		    		...
		    		count++;
		    		try{
		    		    PrintWriter writer = new PrintWriter("C:\\Users\\samir\\Desktop\\2nd Semester\\AI\\HW5\\Dataset\\Validation\\one\\File"+count+".txt", "UTF-8");
		...
		//Matcher matcher = regexp.matcher("");
		//Charset charset = Charset.forName("US-ASCII");
		Path path0 = Paths.get("C:\\Users\\samir\\Desktop\\2nd Semester\\AI\\HW5\\Dataset\\Validation.txt");
		try (BufferedReader reader = Files.newBufferedReader(path0)) {
		    ...
		    while ((line = reader.readLine()) != null) {
		    	...
		    	while (matcher.find()) {
		    		count++;
		    		try{
		    		    PrintWriter writer = new PrintWriter("C:\\Users\\samir\\Desktop\\2nd Semester\\AI\\HW5\\Dataset\\Validation\\zero\\File"+count+".txt", "UTF-8");
		    		    writer.println(line.substring(0,line.length()-2));
		    		    //writer.println("The second line");
		    		    writer.close();
		    		} catch (IOException e) {
